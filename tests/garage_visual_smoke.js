...
assert.ok(html.includes('style.css?v=20260915-progression1')&&html.includes('garage.js?v=20260915-owner1')&&html.includes('car.js?v=20260915-owner1'),'garage cache-bust version not bumped');
