...
assert.ok(html.includes('style.css?v=20260916-adminprefix1')&&html.includes('garage.js?v=20260916-tuning2')&&html.includes('car.js?v=20260916-tuning2'),'garage cache-bust version not bumped');
