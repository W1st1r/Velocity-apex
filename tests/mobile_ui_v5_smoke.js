...
assert.ok(html.includes('css/mobile-ui.css?v=20260917-pause1'),'mobile UI V5 cache-bust missing');
assert.ok(html.includes('js/admin-system.js?v=20260917-admin-daily2'),'admin client cache-bust missing');
