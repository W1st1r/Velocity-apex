...
assert.ok(game.includes("openCatalog('shop')")&&game.includes("openCatalog('garage')")&&game.includes("showShopLanding")&&game.includes("showPersonalShop")&&game.includes("$('shopPersonalBtn').addEventListener('click',showPersonalShop)")&&game.includes('showMarketShop')&&game.includes("$('loadoutBtn').addEventListener('click',openGarage)"),'screen routing missing');
