...
const p1={id:'p1',name:'@fast',connected:true,lastSeq:10,lastStateAt:0,lastSampleTime:base-50,dragChallengeId:challengeId,state:{x:3900,y:2635,vx:500,vy:0,angle:0,speed:500,yawRate:0,sampleTime:base-50,serverTime:base-30}};
const p2={id:'p2',name:'@latepacket',connected:true,lastSeq:20,lastStateAt:0,lastSampleTime:base-40,dragChallengeId:challengeId,state:{x:3900,y:2705,vx:500,vy:0,angle:0,speed:500,yawRate:0,sampleTime:base-40,serverTime:base-20}};
...
await room.handleFreeMessage(socket2,p2,{type:'free_state',state:{seq:21,x:3940,y:2705,vx:500,vy:0,angle:0,speed:500,yawRate:0,sampleTime:base}});
...
await room.handleFreeMessage(socket1,p1,{type:'free_state',state:{seq:11,x:3940,y:2635,vx:500,vy:0,angle:0,speed:500,yawRate:0,sampleTime:base-20}});
