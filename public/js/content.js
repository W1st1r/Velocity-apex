(function(){
  ...
  const CAR_GEOMETRY=Object.freeze({
    "vw-golf-gti":geo(66,28,1.14,1.15,66.2,29.4,0,0,0.0,0.0),
    "honda-civic-type-r":geo(70,29,1.15,1.15,70.8,30.7,0,0,0.0,0.0),
    "toyota-gt86":geo(69,29,1.14,1.14,69.2,30.4,0,0,0.0,0.0),
    "ford-mustang-gt":geo(76,31,1.17,1.17,78.2,33.4,0.4,0,0.3,0.0),
    "subaru-wrx-sti":geo(72,29.5,1.15,1.15,72.9,31.2,0,0,0.0,0.0),
    "bmw-330i":geo(73,29.5,1.15,1.15,73.9,31.2,0,0,0.0,0.0),
    "bmw-m5-f90":geo(78,30.5,1.18,1.17,81.0,33.1,0.3,0,0.22,0.0),
    "mercedes-cls-63-amg":geo(79,30.5,1.18,1.17,82.0,33.1,0.5,0,0.38,0.0),
    "bmw-m4-competition":geo(75,30,1.17,1.16,77.2,32.3,0.2,0,0.15,0.0),
    "mercedes-amg-c63-s":geo(76,30.5,1.17,1.17,78.2,32.8,0.3,0,0.22,0.0),
    "audi-rs5":geo(75,30,1.16,1.16,76.6,32.0,0.2,0,0.15,0.0),
    "nissan-gtr-r35":geo(76,31,1.18,1.18,78.9,33.7,0.2,0,0.15,0.0),
    "chevrolet-corvette-c8":geo(76,31.5,1.19,1.18,79.6,34.5,0.6,0,0.45,0.0),
    "porsche-911":geo(72,30.5,1.18,1.18,74.8,33.1,0,0,0.0,0.0),
    "mercedes-amg-gt-63-s":geo(80,31,1.21,1.2,85.2,34.5,0.7,0,0.52,0.0),
    "bmw-m8-competition":geo(79,31,1.2,1.19,83.4,34.2,0.5,0,0.38,0.0),
    "bentley-continental-gt":geo(81,33,1.21,1.2,86.2,36.7,0.4,0,0.3,0.0),
    "aston-martin-vantage":geo(74,32.5,1.19,1.19,77.5,35.6,0.4,0,0.3,0.0),
    "maserati-mc20":geo(76,32.5,1.2,1.19,80.3,35.9,0.5,0,0.38,0.0),
    "audi-r8":geo(74,32.5,1.19,1.18,77.5,35.6,0.4,0,0.3,0.0),
    "lamborghini-huracan":geo(74,32.2,1.2,1.19,78.1,35.5,0.5,0,0.38,0.0),
    "ferrari-488-gtb":geo(75,32.2,1.2,1.19,79.2,35.5,0.6,0,0.45,0.0),
    "mclaren-720s":geo(75,32,1.2,1.2,79.2,35.3,0.5,0,0.38,0.0),
    "porsche-918-spyder":geo(76,32,1.21,1.2,80.9,35.6,0.3,0,0.22,0.0),
    "lamborghini-aventador":geo(78,33,1.22,1.21,83.7,37.0,0.7,0,0.52,0.0),
    "ford-gt":geo(79,33,1.22,1.21,84.8,37.0,0.8,0,0.6,0.0),
    "bugatti-veyron":geo(77,35,1.22,1.21,82.7,39.3,0.2,0,0.15,0.0),
    "ferrari-enzo":geo(78,34,1.22,1.21,83.7,38.2,1.0,0,0.75,0.0),
    "mclaren-p1":geo(76,32.5,1.21,1.2,80.9,36.2,0.5,0,0.38,0.0),
    "lamborghini-sian":geo(80,34,1.23,1.22,86.6,38.5,0.8,0,0.6,0.0),
    "pagani-huayra":geo(77,34,1.22,1.21,82.7,38.2,0.5,0,0.38,0.0),
    "koenigsegg-agera-rs":geo(77,36,1.22,1.21,82.7,40.4,0.3,0,0.22,0.0),
    "mercedes-benz-slr-mclaren":geo(84,33.5,1.25,1.23,92.4,38.5,1.6,0,1.2,0.0),
    "ferrari-laferrari":geo(79,33.5,1.23,1.22,85.5,37.9,0.8,0,0.6,0.0),
    "bugatti-chiron-super-sport":geo(79,35.5,1.24,1.23,86.2,40.5,0.5,0,0.38,0.0),
    "bugatti-divo":geo(80,35.5,1.24,1.23,87.3,40.5,0.6,0,0.45,0.0),
    "koenigsegg-jesko":geo(80,35,1.24,1.23,87.3,39.9,0.5,0,0.38,0.0),
    "pagani-huayra-bc":geo(78,34.5,1.23,1.22,84.4,39.0,0.4,0,0.3,0.0),
    "lamborghini-veneno":geo(83,34.5,1.25,1.24,91.3,39.7,1.0,0,0.75,0.0),
    "mercedes-amg-one":geo(80,33.8,1.24,1.23,87.3,38.6,0.7,0,0.52,0.0),
    "aston-martin-valkyrie-mary":geo(80,34.5,1.23,1.22,86.6,39.0,0.7,0,0.52,0.0)
  });
