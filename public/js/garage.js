(function(){
  ...
  class Garage{
    constructor(save,onChange){
      ...
      this.car=new R.Car();this.car.x=280;this.car.y=175;this.car.angle=-.20;this.car.speed=260;this.car.throttleVisual=1;
    ...
    render(){
      ...
      this.cards=Array.from(v.items.querySelectorAll('.shop-item')).map(el=>{const car=new R.Car();car.x=155;car.y=56;car.speed=280;car.throttleVisual=1;car.setLoadout(isCars?el.dataset.item:s.previewLivery,isCars?s.previewEffect:el.dataset.item,'thumbnail');return {car,canvas:el.querySelector('canvas')};});
